...
mkdir -p ../../Source/ThirdParty/VTKLibrary/Mac/$VTK_BUILD_CONFIG && cp -a ./Install/$VTK_BUILD_CONFIG/lib/. "$_"
mkdir -p ../../Source/ThirdParty/VTKLibrary/Mac/$VTK_BUILD_CONFIG && cp -a ./Install/$VTK_BUILD_CONFIG/bin/. "$_"
mkdir -p ../../Binaries/ThirdParty/Mac && cp -a ./Install/$VTK_BUILD_CONFIG/lib/. "$_"
