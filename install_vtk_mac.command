...
cmake -G "Unix Makefiles" \
      -DCMAKE_BUILD_TYPE=$VTK_BUILD_CONFIG -DCMAKE_INSTALL_PREFIX=$VTKLIB_DIR/Mac/$VTK_BUILD_CONFIG \
...
mv $VTKLIB_DIR/Mac/$VTK_BUILD_CONFIG/include/vtk-9.3 $VTKLIB_DIR/Public
