...
mkdir -p ../../Source/ThirdParty/VTKLibrary/Linux/x64/$BUILD_CONFIG && cp -a ./Install/$BUILD_CONFIG/lib/. "$_"
mkdir -p ../../Source/ThirdParty/VTKLibrary/Linux/x64/$BUILD_CONFIG && cp -a ./Install/$BUILD_CONFIG/bin/. "$_"
mkdir -p ../../Binaries/ThirdParty/Linux && cp -a ./Install/$BUILD_CONFIG/bin/. "$_"
